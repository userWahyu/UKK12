...
<body>
 ...
 <div class="card">
    <div class="card-header">
      <h2>Ubah Stok Barang</h2>
  <form action="m_ubah_barang.php" method="post">
    </div>
    <div class="card-body">
      <p class="card-text">
      <form action="m_ubah_barang.php" method="post">
    <input type="hidden" name="id_barang" class="form-control" placeholder="Nama Pelanngan" value="<?= $barang['id_barang'] ?>">
    <table>
      <tr>
        <td><input type="text" name="nama_barang" class="form-control" placeholder="Nama Barang" value="<?= $barang['nama_barang'] ?>" readonly ></td>
      </tr>
      <tr>
        <td><input type="text" name="stok_barang" class="form-control" placeholder="Stok Barang" value="<?= $barang['stok_barang'] ?>"></td>
      </tr>
      <tr>
        <td><input type="text" name="harga_barang" class="form-control" placeholder="Harga Barang" value="<?= $barang['harga_barang'] ?>" readonly ></td>
      </tr>
      <tr>
