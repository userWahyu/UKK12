...
(1, 'Extra Joss', 96699, '5000.00'),
(4, 'indomie', 34472, '2500.00'),
(5, 'sabun', 452754, '3000.00'),
(6, 'susu', 32144, '10000.00'),
(7, 'aqua', 24393, '3500.00'),
(8, 'Rinso', 81963, '1500.00');
...
(1, 'AHMADUN', 'madun', '123456', 'Administrator'),
(3, 'AGUSTIAN', 'agus', '123456', 'Petugas'),
(4, 'ARABELLA', 'bella', '123456', 'Petugas');
...
(34059, 'harisun', 'blega', '098763425256'),
(35840, 'wahyu', 'blega', '098763425256');
...
(2, '2024-03-06', '43000.00', 35840, 3),
(6, '2024-03-06', '0.00', 34059, 4);
...
--
ALTER TABLE `tb_detail_penjualan`
  MODIFY `id_detail_penjualan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
